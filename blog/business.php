...
<html lang="zxx">
    ...
    <body>
        <header class="header-area">
            ...
            <div class="navbar-area">
                <div class="sinmun-mobile-nav">
                    <div class="logo">
                        <a href="index-3.html"><img src="assets/img/logo.png" alt="logo"></a>
                    </div>
                </div>
                <div class="sinmun-nav">
                    <div class="container">
                        <nav class="navbar navbar-expand-md navbar-light">
                            <a class="navbar-brand" href="index-3.html"><img src="assets/img/logo.png" alt="logo"></a>
                        ...
                        <div class="new-news-list">
                            <div class="single-new-news">
                                ...
                                <div class="news-content">
                                    ...
                                    <h3><a href="single-post-4.html">Create the Perfect Logo for your Website</a></h3>
                                </div>
                        ...
                        <div class="new-news-slides owl-carousel owl-theme">
                            <div class="single-default-news">
                                ...
                                <div class="news-content">
                                    ...
                                    <h3><a href="single-post-2.html">As well as stopping goals, Cristiane Endler is opening doors for other women.</a></h3>
                                </div>
        ...
        <section class="technology-area pb-40">
            <div class="container">
                <div class="section-title"><h2>Technology</h2></div>
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                    ...
                    <div class="col-lg-3 col-md-12">
                        <div class="technology-section-ads">
                           <a href="single-post-4.html"><img src="assets/img/6-ads.png" alt="image"></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="video-news-area ptb-40">
            <div class="container">
                <div class="section-title"><h2>Watch Videos</h2></div>
                <div class="row">
        ...
        <section class="international-news-area ptb-40 pb-0">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                    ...
                    <div class="col-lg-4">
                        <div class="section-title"><h2>Stay Connected</h2></div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="health-lifestyle-news">
                                    <div class="section-title"><h2>Health & Lifestyle</h2></div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="politics-news">
                                    <div class="section-title"><h2>Politics</h2></div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12">
                        <div class="gallery-news">
                            <div class="section-title"><h2>Gallery News</h2></div>
                            <div class="gallery-news-inner-slides owl-carousel owl-theme">
                                <div class="row align-items-center m-0">
                                    <div class="col-lg-6 col-md-6 p-0">
                                        <div class="gallery-news-content">
                                            <h3>
                                                <a href="single-post-2.html"><i class="icofont-camera-alt"></i> A glance (18 June 2024)</a>
                                            </h3>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="gallery-news-list">
                            <div class="media gallery-news-media align-items-center">
                                <div class="image">
                                   <img src="assets/img/small-4.jpg" alt="image"> <a href="single-post-3.html"><i class="icofont-ui-camera"></i></a>
                                </div>
                                <div class="content">
                                    <h3>
                                        <a href="single-post-3.html"><i class="icofont-camera-alt"></i> A glance (17 June 2024)</a>
                                    </h3>
                                </div>
                            </div>
                            <div class="media gallery-news-media align-items-center">
                                <div class="image">
                                    <img src="assets/img/small-2.jpg" alt="image"> <a href="single-post-3.html"><i class="icofont-ui-camera"></i></a>
                                </div>
                                <div class="content">
                                    <h3>
                                        <a href="single-post-1.html"><i class="icofont-camera-alt"></i> A glance (16 June 2024)</a>
                                    </h3>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="fashion-news">
                            <div class="section-title"><h2>Fashion</h2></div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="food-news">
                            <div class="section-title"><h2>Food & Hobbbies</h2></div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="north-america-news">
                            <div class="section-title"><h2>North America</h2></div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="economics-news">
                            <div class="section-title"><h2>Economics</h2></div>
                            <div class="single-fashion-news">
                                <img src="assets/img/4.jpg" alt="image">
                                <div class="news-content">
                                    <ul>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="science-technology-news">
                            <div class="section-title"><h2>Science and Technology</h2></div>
                            <div class="single-food-news">
                                <img src="assets/img/5.jpg" alt="image">
                                <div class="news-content">
                                    <ul>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="living-life-news">
                            <div class="section-title"><h2>Living Life</h2></div>
                            <div class="single-north-america-news">
                                <img src="assets/img/6.jpg" alt="image">
                                <div class="news-content">
                                    <ul>
        ...
        <section class="more-news-area">
            <div class="container">
                <div class="more-news-inner">
                    <div class="section-title"><h2>More News</h2></div>
                    <div class="row">
                        ...
                        <div class="single-footer-widget">
                            ...
                            <div class="contact-info">
                                ...
                                <ul>
                                    ...
                                    <li><i class="icofont-envelope"></i> <a href="/cdn-cgi/l/email-protection#254c4b434a65564c4b48504b0b464a48"><span class="__cf_email__" data-cfemail="0c65626a634c7f6562617962226f6361">[email&#160;protected]</span></a></li>
                                </ul>
                            </div>
