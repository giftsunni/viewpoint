                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-4 text-end">
                            <ul class="top-social">
                                <li><a href="https://www.facebook.com/login/" target="_blank"><i class="icofont-facebook"></i></a></li>
                                <li><a href="https://twitter.com/login/" target="_blank"><i class="icofont-twitter"></i></a></li>
                                <li><a href="https://www.instagram.com/accounts/login/" target="_blank"><i class="icofont-instagram"></i></a></li>
                                <li><a href="https://www.pinterest.com/login/" target="_blank"><i class="icofont-pinterest"></i></a></li>
                                <li><a href="https://vimeo.com/log_in" target="_blank"><i class="icofont-vimeo"></i></a></li>
                            </ul>
                            ...
                            <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item"><a href="#" class="nav-link active">Pages</a>
                                        <ul class="dropdown-menu">
                                            <li class="nav-item"><a href="#" class="nav-link active">Category Layout</a>
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li class="nav-item"><a href="post-category-5.html" class="nav-link active">Category Layout 5</a></li>

                                                    <li class="nav-item"><a href="post-category-6.html" class="nav-link">Category Layout 6</a></li>
                                                </ul>
                                            </li>

                                            <li class="nav-item"><a href="#" class="nav-link">Post Formate</a>
                                                <ul class="dropdown-menu">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12">
                            ...
                            <div class="row m-0 align-items-center">
                                <div class="col-lg-5 col-md-6 p-0">
                                    <div class="category-news-image">
                                        <a href="single-post-3.html"><img src="assets/img/1.jpg" alt="image"></a>
                                ...
                                <div class="col-lg-7 col-md-6">
                                    <div class="category-news-content">
                                        ...
                                        <h3><a href="single-post-1.html">Erik Jones Has Day He Won’t Soon Forget As Denny Backup At Bristol</a></h3>
                        ...
                        <div class="single-category-news">
                            <div class="row m-0 align-items-center">
                                <div class="col-lg-5 col-md-6 p-0">
                                    <div class="category-news-image">
                                        <a href="single-post-2.html"><img src="assets/img/6.jpg" alt="image"></a>
                        ...
                        <div class="single-category-news">
                            <div class="row m-0 align-items-center">
                                <div class="col-lg-5 col-md-6 p-0">
                                    <div class="category-news-image">
                                        <a href="single-post-2.html"><img src="assets/img/5.jpg" alt="image"></a>
                        ...
                        <div class="single-category-news">
                            <div class="row m-0 align-items-center">
                                <div class="col-lg-5 col-md-6 p-0">
                                    <div class="category-news-image">
                                        <a href="single-post-3.html"><img src="assets/img/4.jpg" alt="image"></a>
                        ...
                        <div class="single-category-news">
                            <div class="row m-0 align-items-center">
                                <div class="col-lg-5 col-md-6 p-0">
                                    <div class="category-news-image">
                                        <a href="single-post-2.html"><img src="assets/img/3.jpg" alt="image"></a>
                        ...
                        <div class="single-category-news">
                            <div class="row m-0 align-items-center">
                                <div class="col-lg-5 col-md-6 p-0">
                                    <div class="category-news-image">
                                        <a href="single-post-2.html"><img src="assets/img/2.jpg" alt="image"></a>
                        ...
                        <div class="pagination-area">
                            <a href="post-category-5.html" class="prev page-numbers"><i class="icofont-double-left"></i></a>
                            <a href="post-category-5.html" class="page-numbers">1</a>
                            <span class="page-numbers current" aria-current="page">2</span>
                            <a href="post-category-5.html" class="page-numbers">3</a>
                            <a href="post-category-5.html" class="page-numbers">4</a>
                            <a href="post-category-5.html" class="next page-numbers"><i class="icofont-double-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        ...
                        <div class="hot-news-ads">
                            <a href="single-post-2.html"><img src="assets/img/4-ads.png" alt="image"></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="single-footer-widget">
                            ...
                            <div class="contact-info">
                                ...
                                <ul>
                                    ...
                                    <li><i class="icofont-envelope"></i> <a href="/cdn-cgi/l/email-protection#224b4c444d62514b4c4f574c0c414d4f"><span class="__cf_email__" data-cfemail="7a13141c153a091314170f1454191517">[email&#160;protected]</span></a></li>
                                </ul>
                            </div>
                            ...
                            <div class="connect-social">
                                ...
                                <ul>
                                    <li><a href="https://www.facebook.com/login/" target="_blank"><i class="icofont-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/login/" target="_blank"><i class="icofont-twitter"></i></a></li>
                                    <li><a href="https://linkedin.com/login" target="_blank"><i class="icofont-linkedin"></i></a></li>
                                    <li><a href="https://www.instagram.com/accounts/login/" target="_blank"><i class="icofont-instagram"></i></a></li>
                                    <li><a href="https://rss.com/login/" target="_blank"><i class="icofont-rss"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="footer-latest-news-list">
                                <div class="media latest-news-media align-items-center">
                                    <a href="single-post-1.html">
                                        <img src="assets/img/small-2.jpg" alt="image">
                                    </a>

                                    <div class="content">
                                        <ul>
                                            <li><i class="icofont-calendar"></i> March 22, 2024</li>
                                            <li><a href="single-post-3.html"><i class="icofont-comment"></i> 12</a></li>
                                        </ul>
                                ...
                                <div class="media latest-news-media align-items-center">
                                    <a href="single-post-1.html">
                                        <img src="assets/img/small-4.jpg" alt="image">
                                    </a>
                                ...
                                <div class="media latest-news-media align-items-center">
                                    <a href="single-post-2.html">
                                        <img src="assets/img/small-3.jpg" alt="image">
                                    </a>
